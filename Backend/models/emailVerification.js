function EmailVerification({ id, email, secret_code }) {
    // private variables
    let _id = id;
    const _email = email;
...
const EmailVerificationFromFirestore = ({ mapData, docId }) => {
    let email_verification_instance = new EmailVerification({
        id: docId,
        email: mapData["email"],
