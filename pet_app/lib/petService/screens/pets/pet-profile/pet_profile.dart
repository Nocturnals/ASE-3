      ...
      if (displayedPet.forPetSitting)
        IconButton(
            ...
            onPressed: () async {
              ...
              _chatService.sendMessage(displayedPet.ownerId,
                  "Hi, ${owner.username}! I'd like to pet sit ${displayedPet.name}.");
      ...
      if (displayedPet.forPetMating)
        IconButton(
          ...
          onPressed: () async {
            User owner = await _userService.getUser(displayedPet.ownerId);
            _chatService.sendMessage(displayedPet.ownerId,
                "Hi, ${owner.username}! I have a potential mate for ${displayedPet.name}.");
            Navigator.of(context)
                .pushNamed(ChatPage.routeName, arguments: owner);
          },
        ),
      ...
      child: Padding(
        ...
        child: ListTile(
          leading: Icon(
            ...
            color:
                (displayedPet.forPetSitting ? Colors.black54 : Colors.black26),
          ),
          title: Text(
            "" +
      ...
      child: Padding(
        ...
        child: ListTile(
          leading: Icon(
            Icons.pets,
            color:
                (displayedPet.forPetMating ? Colors.black54 : Colors.black26),
          ),
          title: Text(
            "" +
