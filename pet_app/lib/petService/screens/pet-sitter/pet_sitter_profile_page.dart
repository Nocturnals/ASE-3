...
class PetSitterProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text(petSitter.username), actions: actions(context)),
  ...
  actions(BuildContext context) {
    return <Widget>[
      IconButton(
        ...
        onPressed: () {
          _chatService.sendMessage(petSitter.uid,
              "Hi, ${petSitter.username}! I need a pet sitter. Are you interested?");
