...
class Service extends Equatable {
  ...
  Service.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        category =
            EnumToString.fromString(ServiceCategory.values, json['category']),
  ...
  Service.fromDocumentSnapshot(DocumentSnapshot snapshot)
      : id = snapshot.documentID,
        ...
        category = EnumToString.fromString(
            ServiceCategory.values, snapshot.data['category']),
        petType =
            EnumToString.fromString(PetType.values, snapshot.data['pet_type']);
