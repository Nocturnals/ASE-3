...
class _FieldsState extends State<Fields> {
  ...
  void validateAndSubmit(CreatePostViewModel createPostViewModel) async {
    ...
    if (form.validate()) {
      ...
      createPostViewModel.create(description: _description, mediaUrls: _mediaUrls);
      setState(() {
  ...
  // App Bar
  Widget _appBar(CreatePostViewModel createPostViewModel) {
    return AppBar(
      // Title
      title: Text("New Post"),
      centerTitle: true,
      ...
      actions: <Widget>[
        GestureDetector(
          onTap: () { 
            ...
            SnackBar(content: Text("Select an image to continue."));
          },
          child: Text(
            "Upload",
            style: TextStyle(
          ...
          : Stack(
            children: <Widget>[
              ...
              Material(
                elevation: 0,
                child: Scaffold(
                  appBar: _appBar(createPostViewModel),
                  body: ListView(
                    children: <Widget>[
                      // Image Field
                      _imagePickerField(),
