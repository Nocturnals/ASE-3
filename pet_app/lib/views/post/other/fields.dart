...
class _FieldsState extends State<Fields> {
  ...
  Widget build(BuildContext context) {
    ...
    OtherPostPopUpItems popUpItems = new OtherPostPopUpItems();
    popUpItems.username = 'neelakanta.sriram';
    List<Map<String, String>> postPopUpItems = popUpItems.popUpItems;

    // login redirect alert dialogue
    Future<void> _loginRedirectAlert(String message) async {
    ...
    Widget _likeButtonField(PostViewModel postViewModel, bool liked, bool isAuthed) {
      ...
      return IconButton(
        ...
        onPressed: () {
          if (this.mounted) {
            isAuthed
            ? _onHitLikeButton(postViewModel)
            : _loginRedirectAlert("If you want to like the post, Please log in.");
          }
        },
      );
    }
      ...
      return IconButton(
        ...
        onPressed: () {
          if (this.mounted) {
            ...
            : _loginRedirectAlert("Login to save the post"); 
          }
        }
      );
    }
